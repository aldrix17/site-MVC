...
class Commentaire extends Modele {
    public function getCommentaires(string $idBillet){
        $pdo = self::getPDO();
        $stmt = $pdo->prepare(
    ...
    public function ajouterCommentaire(string $auteur, string $contenu, string $idBillet){
        $pdo = self::getPDO();
        try {
             $stmt = $pdo->prepare(
